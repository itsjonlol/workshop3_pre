...
public class ContactService {
    ...
    public void saveUser(User user) {
        contactRepo.setHash(Util.redisKey, user.getId(), user.toString());
        
    }

    public User getUserById(String id) {
        String rawIndividualUserData = contactRepo.getValueFromHash(Util.redisKey, id);
    ...
    public Boolean checkIfUserExists(String id) {
        return contactRepo.hasKey(Util.redisKey, id);

    }
    public Boolean deleteUser(String id) {
        return contactRepo.deleteKeyFromHash(Util.redisKey, id);
    }

    public List<User> getAllUsers() {
        List<Object> objectList = contactRepo.getAllValuesFromHash(Util.redisKey);
